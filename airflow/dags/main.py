...
extract_load_task = BashOperator(
    ...
    bash_command = "spark-submit /opt/airflow/code/push_data_to_hdfs.py",
    dag = dag
)
...
transform_google_play_task = BashOperator(
    ...
    bash_command = "spark-submit  --conf spark.sql.parquet.enableVectorizedReader=false --driver-class-path /opt/airflow/code/postgresql-42.2.5.jar /opt/airflow/code/transform_google_play.py", 
    dag = dag
)
